...
CREATE TABLE IF NOT EXISTS candidates (
  ...
  auto_apply_min_score DECIMAL(5,2) NOT NULL DEFAULT 70.00,
...
CREATE TABLE IF NOT EXISTS applications (
  ...
  cv_url VARCHAR(255),
  cv_filename VARCHAR(255),
  cv_source VARCHAR(20) NOT NULL DEFAULT 'profile',
  application_source VARCHAR(20) NOT NULL DEFAULT 'manual',
  cover_letter TEXT,
